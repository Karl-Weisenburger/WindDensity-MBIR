...
sensor_locations = [sensor_one, sensor_two]
...
sensor_one_angles = jnp.array([-11]) * jnp.pi / 180
sensor_two_angles = jnp.array([0,3]) * jnp.pi / 180

beam_angles=[sensor_one_angles,sensor_two_angles]
...
# set values outside of FOV to nan and crop to apeture
...
display_raw_data_and_processed_data(OPD_raw,sinogram)
plt.show()
